...
from YTDownload import start_download  # Importeer de start_download functie
...
class MyApp(App):
    ...
    def on_DLbutton_press(self, instance):
        ...
        for i, title in enumerate(listTitle):
            ...
            button.bind(on_press=lambda btn, url=listURL[i]: start_download(url))  # Bind the button to the click event
